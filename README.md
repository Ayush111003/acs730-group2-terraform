...
================================================================================
  ...
  ---------------------------------------------------------------
  Create three separate buckets -- one per environment:
  ...
  No new key pair needs to be generated.
  ...
  ---------------------------------------------------------
  *** WARNING: If using AWS Academy, your IP changes every session.
               Run this step each time. ***
...
================================================================================
  ...
  *** WARNING: Always deploy Network before Webservers.
...
================================================================================
  ...
  Refresh multiple times to see different Instance IDs -- confirms load balancing.
...
================================================================================
  ...
  Automated security scanning is configured using tfsec:
    ...
    - Triggers on every pull request to the prod branch
...
================================================================================
  ...
  *** WARNING: Always destroy Webservers before Network.
               Always destroy Prod > Staging > Dev.            ***

  *** WARNING: NAT Gateway charges per hour -- destroy after testing! ***
